...
sed -i "s|^CUSTOM_USER=\".*|CUSTOM_USER=\""$MY_CUSTOM_USER"\"|" $MY_CUSTOM_HOME/elrond-go-scripts-mainnet/config/variables.cfg
sed -i "s|^SSHPORT=\".*|SSHPORT=\""$MY_SSHPORT"\"|" $MY_CUSTOM_HOME/elrond-go-scripts-mainnet/config/variables.cfg
